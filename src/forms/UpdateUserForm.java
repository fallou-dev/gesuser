...
public class UpdateUserForm {
	...
	private static final String ECHEC_UPDATE_MESSAGE="Echec de la modification";
	private static final String SUCCES_UPDATE_MESSAGE="Modification effectué avec succes ";
	...
	public UpdateUserForm(HttpServletRequest request ) {
          ...
          this.status=false;
          this.StatusMessage=ECHEC_UPDATE_MESSAGE;       
	...
	public boolean update(int id) {
	    ...
	    {
	    	users.modifierUtilisateur(utilisateur);
	    	this.status=true;
	    	this.StatusMessage=SUCCES_UPDATE_MESSAGE;
	    }
	    return this.status;
	}
